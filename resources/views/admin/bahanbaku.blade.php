<x-layout-admin>
    <x-slot:title>Harga Bahan Baku</x-slot>
    <x-slot:tabs>Manager-Harga Bahan Baku</x-slot>
                            ...
                            <table class="table table-bordered table-striped table-sm border border-dark align-middle">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 20%;">Harga/satuan (zak)</th>
                                ...
                                <tbody>
                                    @foreach ($bahanbaku as $index => $item)
                                        <tr>
                                            ...
                                            <td style="text-align: right;">{{ number_format($item->harga_persatuan) }}</td>
                                            <td style="text-align: right;">{{ number_format($item->harga_perkilo) }}</td>
                                            <td>
                                                <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#editbahanbaku-{{ $item->id }}">Edit</button>
                                                <a href="/deletebahanbaku/{{ $item->id }}" class="btn btn-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus bahan baku {{ $item->nama_bahan }}?')">Hapus</a>
                                            </td>
                                        </tr>
                            ...
                            <table class="table table-bordered table-striped table-sm border border-dark align-middle">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Nama Bahan</th>
                                        <th>Satuan</th>
                                        <th style="width: 10%;">Harga /satuan (zak)</th>
                                        <th style="width: 9%; text-align:center;">Aksi</th>
                                    </tr>
                                </thead>
                                <tbody>
