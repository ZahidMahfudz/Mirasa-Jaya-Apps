<x-layout-manager>
  <x-slot:title>Pengeluaran</x-slot>
  <x-slot:tabs>Manager-Pengeluaran</x-slot>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="/manager/tambahPengeluaran" method="POST">
                        @csrf
                        <div class="mt-3">
  ...
  <div class="card mt-3">
    <div class="card-header">
      <h4>Pengeluaran Hari Ini {{ \Carbon\Carbon::parse($date)->translatedFormat('l, d F Y') }}</h4>
    </div>
    <div class="card-body">
      <div>
