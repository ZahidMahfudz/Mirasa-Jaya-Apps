        ...
        <table class="table table-bordered border border-dark" id="table1">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align: center;">{{ \Carbon\Carbon::parse($projects->tanggal)->translatedFormat('d F Y') }}</td>
                    <td>{{ $projects->hal }}</td>
                    <td style="text-align: right;">{{ number_format($projects->jumlah) }}</td>
                </tr>
                @endforeach
                <tr>
                    <td colspan="3" style="text-align: right"><strong>Total</strong></td>
                    <td style="text-align: right"><strong>{{ number_format($totalProject) }}</strong></td>
                </tr>
            </tbody>
        </table>
    </div>
