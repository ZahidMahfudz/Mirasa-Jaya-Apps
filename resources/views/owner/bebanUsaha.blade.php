<x-layout-owner>
    ...
    <x-slot:tabs>Owner-Beban Usaha</x-slot>

    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                <div class="mt-3">
                        <form action="/user/owner/filterbebanusaha" method="GET">
                            @csrf
                            <div class="row align-items-center">
                                <div class="col-auto">
                                    <h5>Beban Usaha Periode</h5>
                                </div>
                                <div class="col">
                                    <input type="date" class="form-control" id="startDate" name="startDate" value="{{ $startOfWeek ?? '' }}">
                                </div>
                                <div class="col-auto">
                                    <h5>s/d</h5>
                                </div>
                                <div class="col">
                                    <input type="date" class="form-control" id="endDate" name="endDate" value="{{ $endOfWeek ?? '' }}">
                                </div>
                                <div class="col-auto">
                ...
                <div class="mt-1">
                    <a href="#" onclick="this.href='/user/owner/cetak-beban-usaha/' + document.getElementById('startDate').value + '/' + document.getElementById('endDate').value" class="btn btn-secondary" target="_blank">Cetak</a>
                </div>
            </div>
        </div>
