<x-layout-owner>
    <x-slot:title>Neraca Saldo</x-slot>
    <x-slot:tabs>Manager-Neraca Saldo</x-slot>
    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <div class="mt-3">
                        <form action="{{ url('/filterNeraca') }}" method="post">
                            @csrf
                            <div class="row">
                                <div class="col" style="width: 350px;">
                                    <p>Periode 1 Januari sampai : </p>
                                </div>
                                <div class="col">
                ...
                <div class="mt-1">
                    <a href="" onclick=" this.href='/cetak-Neraca/'+ document.getElementById('tanggal').value " class="btn btn-secondary" target="_blank" >Cetak</a>
                </div>
            </div>
        </div>
        <div class="card-body">
