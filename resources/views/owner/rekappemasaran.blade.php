<x-layout-owner>
    ...
    <x-slot:tabs>Owner-Rekapitulasi Pemasaran</x-slot>

    <div class="card mt-3">
        <div class="card-header">
            <div  class="d-flex justify-content-between align-items-center">
                <div class="mt-3">
                        <form action="/user/owner/filterRekapPemasaran" method="GET">
                            @csrf
                            <div class="row align-items-center">
                                <div class="col-auto">
                                    <h5>Rekapitulasi Pemasaran Periode</h5>
                                </div>
                                <div class="col">
                ...
                <div class="mt-2">
                    <a href="#" onclick=" this.href='/user/owner/cetak-rekap-pemasaran/'+ document.getElementById('startDate').value + '/' + document.getElementById('endDate').value " class="btn btn-secondary" target="_blank" >Cetak</a>
                </div>
            </div>
        </div>
        <div class="card-body">
